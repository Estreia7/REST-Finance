 ...
 */
function ShoeboxFigure({ title }: FigureProps) {
  return (
...
function FlowFigure({ title }: FigureProps) {
  return (
...
function BeforeAfterFigure({ title }: FigureProps) {
  return (
...
function RotaFigure({ title, costLabel }: FigureProps & { costLabel: string }) {
